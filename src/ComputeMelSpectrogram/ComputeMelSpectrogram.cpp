...
int main(int argc, char* argv[])
{
    ...
    stMelConfig.bIsLogarithmic = true;
    ...
    pCSpectrogram->compMelSpectrogram(ppfSpectrogram, &stMelConfig);
...
void     showClInfo()
{
    cout << "ACA v" << getAcaVersion() << ": Demo Executable for Mel Spectrogram Extraction" << endl;
